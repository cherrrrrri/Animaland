...
public class dialog_roomexit2 extends Dialog {
    private Button yes,no;
    private View.OnClickListener listenerOfYes,listenerOfNo;

    public dialog_roomexit2(@NonNull Context context) {
        super(context);
    }

    public dialog_roomexit2(@NonNull Context context, int themeResId) {
        super(context, themeResId);
    }

    public dialog_roomexit2 setYes(View.OnClickListener listener) {
        this.listenerOfYes=listener;
        return this;
    }

    public dialog_roomexit2 setNo(View.OnClickListener listener) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_roomexit2);

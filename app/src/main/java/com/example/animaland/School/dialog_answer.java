...
public class dialog_answer extends Dialog {
    ...
    public dialog_answer setClose(View.OnClickListener listener) {
        this.ListenerOfClose=listener;
        return this;
    }

    public dialog_answer setButton(View.OnClickListener listener) {
        this.ListenerOfButton=listener;
        return this;
    }

    public String getAnswer(){
        return answer_hint.getText().toString();
    }
    public dialog_answer(@NonNull Context context, int themeID) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //找到控件
        answer_hint =findViewById(R.id.question_hint);
        close=findViewById(R.id.close);
        send=findViewById(R.id.btn_send);

        answer_hint.setHint("请输入你的回答");

...
///@endcond
  ...
  */
  ...
  @param low_gain The higher the parameter value, the deeper the sound. The value range is [-1.0,1.0].
  @param high_gain The higher the parameter value, the sharper the sound. The value range is [-1.0,1.0].
  @return
  - 0: Success.
  - < 0: Failure.
    - -1(ERR_FAILED): A general error occurs (no specified reason).
  */
  virtual int setHeadphoneEQParameters(float low_gain, float high_gain) = 0;

...
"D:\\android SDK\\AndroidSDK\\cmake\\3.18.1\\bin\\cmake.exe" ^
  ...
  "-DCMAKE_LIBRARY_OUTPUT_DIRECTORY=D:\\Animaland\\open\\build\\intermediates\\cxx\\Debug\\5d2q3s6e\\obj\\x86" ^
  "-DCMAKE_RUNTIME_OUTPUT_DIRECTORY=D:\\Animaland\\open\\build\\intermediates\\cxx\\Debug\\5d2q3s6e\\obj\\x86" ^
  "-DCMAKE_BUILD_TYPE=Debug" ^
  "-BD:\\Animaland\\open\\.cxx\\Debug\\5d2q3s6e\\x86" ^
  -GNinja ^
